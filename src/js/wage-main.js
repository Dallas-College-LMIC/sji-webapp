...
// Initialize the wage map controller when DOM is loaded
document.addEventListener('DOMContentLoaded', async () => {
    try {
        const wageController = new WageMapController('mainmap');
    } catch (error) {
        console.error('Failed to initialize wage map:', error);
